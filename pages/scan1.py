...
if st.button('計算を行う'):
  for code in codes1_2:
      ...
      for i in range(60,285):
          ...
          #均衡表の好転
          if conversion_line>=base_line and conversion_line_yesterday<base_line_yesterday and price>conversion_line and conversion_direction>0 and RSI_today<30  and ema30>ema40>ema50>ema60 and ema30_direction>0 and ema40_direction>0 and ema50_direction>0 and ema60_direction>0:
              check1_all.append(i)
