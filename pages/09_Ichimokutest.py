...
st.subheader('均衡表の好転が起きたときに上がる確率は'+ str(step1) + '%')
st.subheader('上がり幅の平均は' + str(price1) + '円')
st.subheader('起きた回数は' + str(len(percent_step1)) + '回')
st.subheader('遅行スパンが好転したときに上がる確率は'+ str(step2) + '%')
st.subheader('上がり幅の平均は' + str(price2) + '円')
st.subheader('起きた回数は' + str(len(percent_step2)) + '回')
st.subheader('三役好転のときに上がる確率は'+ str(step3) + '%')
st.subheader('上がり幅の平均は' + str(price3) + '円')
st.subheader('起きた回数は' + str(len(percent_step3)) + '回')
