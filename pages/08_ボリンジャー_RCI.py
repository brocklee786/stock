...
if option:
        ...
        for i in range(50,950):
            ...
            if rci_short>80 and rci_long>80 and bollinger_direction>0 and price_today>bollinger_today and price_yesterday>bollinger_yesterday and price_day>bollinger_day and price_direction>0 and price_direction2>0 and price_direction3>0 and price_direction>price_direction2>price_direction3:
                all.append(i)
                if price_dif>0:
                    up.append(i)
