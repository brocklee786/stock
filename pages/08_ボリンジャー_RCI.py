...
if option:
        ...
        for i in range(50,950):
            ...
            if rci_short>80 and rci_long>80 and bollinger_direction>0 and price_today>bollinger_today and price_direction>0 price_direction2>0 and price_direction3>0:
                all.append(i)
                if price_dif>0:
                    up.append(i)
