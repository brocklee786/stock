        ...
        for i in range(15,days):
                ...
                if sub1<0 and sub2>0:
                        if sub3 < 50:
                                ...
                                AVE_RSI = (source['RSI'][2000-i-1] + source['RSI'][2000-i] + source['RSI'][2000-i+1] + source['RSI'][2000-i+2] + source['RSI'][2000-i+3]) / 5
        ...
        for i in range(15,days):
                ...
                if sub1>0 and sub2<0:
                        if source['RSI'][2013-i] > 50:
                                ...
                                AVE_RSI2 = (source['RSI'][2000-i-1] + source['RSI'][2000-i] + source['RSI'][2000-i+1] + source['RSI'][2000-i+2] + source['RSI'][2000-i+3]) / 5
